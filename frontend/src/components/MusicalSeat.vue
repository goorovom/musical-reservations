<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-title v-if="value._links">
            Seat # {{decode(value._links.self.href.split("/")[value._links.self.href.split("/").length - 1])}}
        </v-card-title >
        <v-card-title v-else>
            Seat
        </v-card-title >        
        ...
        <v-card-text>
            <Number label="musicalId" v-model="value.musicalId" :editMode="editMode" :inputUI="''"/>
            <String label="Grade" v-model="value.grade" :editMode="editMode" :inputUI="''"/>
